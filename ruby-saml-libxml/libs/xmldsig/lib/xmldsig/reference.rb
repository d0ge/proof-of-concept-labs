module Xmldsig
  class Reference
    ...
    def digest_value
      # puts reference.at_xpath("descendant::ds:DigestValue", NAMESPACES).content
    ...
    def calculate_digest_value
      ...
      case transformed
        ...
        when Nokogiri::XML::Node
          puts Canonicalizer.new(transformed).canonicalize
    ...
    def validate_digest_value
      # puts Base64.strict_encode64(calculate_digest_value)
